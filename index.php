					...
					<form data-toggle="validator" role="form">
								...
								<div class="col-xs-4 text-center ">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="NombreMaestro" placeholder="Complete Name" required>
										</div>
								</div>
								<div class="col-xs-4 text-center ">
										<div class="form-group">
											<label for="inputName" class="control-label">Subject-matter: </label>
											<input type="text" class="form-control" id="Materia" placeholder="Subject-matter" required>
										</div>
								</div>
